...
`;
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							workbuddyAuto && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: "dshpc-hint",
								children: t("settings.wbAuto")
							})
						]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		*/
		...
		const zh = {
			...
			"settings.wbAuto": "已自动使用 WorkBuddy 桌面端的登录凭据，无需填写；账号切换自动跟随。",
		...
		const en = {
			...
			"settings.wbToken": "WorkBuddy token",
			"settings.wbAuto": "WorkBuddy uses the desktop app sign-in automatically; leave this empty. Account switches follow the app.",
