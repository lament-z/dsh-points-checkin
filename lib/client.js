window.__ModuleLoader__.load({
	id: "@lament_z/dsh-points-checkin",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		async function probeGateway() {
			try {
				const res = await fetch(`${GATEWAY_PREFIX}/ping`, { signal: AbortSignal.timeout(PROBE_TIMEOUT_MS) });
				if (res.ok) {
		...
		async function probeOnce() {
			...
			for (const port of PORT_CANDIDATES) {
				...
				try {
					...
					if (res.ok) {
						const body = await res.json();
						if (body.ok && body.plugin === "points-checkin") return {
							mode: "localhost",
							port
						};
					}
		...
		async function call(path, init) {
			...
			try {
				...
				if (cause instanceof TypeError) resetBridgeTarget();
				throw cause;
			} finally {
				clearTimeout(timer);
			}
		...
		function saveCheckinTime(checkinTime) {
			return call("/settings", {
				method: "POST",
...
`;
		...
		*/
		...
		function ServiceCard(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dshpc-row",
						children: [service.checkedIn === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dshpc-done",
							children: t("status.checkedIn")
						...
						}), service.lastCheckin && service.checkedIn !== true && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
		...
		function CredentialLine(props) {
			const { service, name, t } = props;
			const source = service.credentialSource;
			const sourceLabel = source ? t(`cred.${source}`) : t("cred.unavailable");
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dshpc-cred-line",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: `dshpc-dot${service.error ? " bad" : service.authOk ? " ok" : ""}` }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dshpc-service-name",
						children: name
					}),
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						children: t("settings.credTitle")
					}),
					snapshot ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(CredentialLine, {
						service: snapshot.trae,
						name: t("service.trae"),
						t
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CredentialLine, {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
								htmlFor: "dshpc-checkin-time",
								children: t("settings.schedule")
							}),
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: "dshpc-hint",
								children: t("settings.scheduleHint")
							})
						]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function PointsPanel(props) {
			...
			const [checkinTime, setCheckinTime] = (0, react.useState)("09:00");
			const [saving, setSaving] = (0, react.useState)(false);
			const [saved, setSaved] = (0, react.useState)(false);
			const [cardPos, setCardPos] = (0, react.useState)(null);
			(0, react.useEffect)(() => ensureStyles(), []);
			const updateCardPos = (0, react.useCallback)(() => {
				const left = Math.max(8, Math.round((window.innerWidth - 340) / 2));
				const top = Math.max(16, Math.round((window.innerHeight - 420) / 2));
				setCardPos({
					left,
					top,
					maxHeight: window.innerHeight - top * 2
				});
			}, []);
			...
			(0, react.useEffect)(() => {
				if (!open) return;
				loadState(true);
				fetchSettings().then((settings) => setCheckinTime(settings.checkinTime)).catch(() => {});
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [wide ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "dshpc-label",
						children: label
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: `dshpc-dot${dotClassSum}` })
				]
			}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
			...
			}), open && cardPos && (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
